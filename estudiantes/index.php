...
?>
<!DOCTYPE html>
<html lang="en" ng-app="ListaEstudiante">
			...
			<div class="col g-ml-45 g-ml-0--lg g-pb-65--md" id="ListaContainer" ng-controller="ListaCtrl" ng-cloak>
				...
				<div class="container g-py-50">
					<ul class="u-list-inline g-font-weight-500 mb-2">
						...
						<li class="list-inline-item g-mr-5">
							<a class="u-link-v5 g-color-gray-dark-v5 g-color-main--hover" href="#">Estudiantes</a>
							<i class="g-color-gray-light-v2 g-ml-5 fa fa-angle-right"></i>
						</li>
				...
				<div class="row g-brd-gray-light-v7">	
					...
					<div class="container">
						...
						<div class="row g-mb-70" ng-show="view=='GRID'">
							<div class="col-sm-6 col-lg-3 g-mb-30 " ng-repeat="estudiante in listaData">
								<!-- Agents -->
									<div class="u-shadow-v11 u-shadow-v21--hover  text-center g-transition-0_3 ">
										<div class="g-bg-white g-pa-20">
											<div class=" mx-auto mb-10">
												<img class="img-fluid g-brd-around g-brd-3 g-brd-gray-light-v3 g-width-130 g-height-130 rounded-circle rounded " src="{{estudiante.image}}" alt="Image Description">
											</div>
											<h3 class="h5"><a class="g-color-main" href="#">{{estudiante.name}}</a></h3>
											<span class="d-block g-color-gray-dark-v5 g-font-size-13 mb-1 g-height-20" >Patronus: {{estudiante.patronus}}</span>
											<span class="d-block g-font-size-13 g-height-20" >Age: {{estudiante.age}} <span ng-hide="estudiante.age==''">years old</span> </span>
										</div>
									</div>
								<!-- End Agents -->
							</div>
						...
						<div class="card g-brd-gray-light-v7 g-mb-30" ng-show="view=='TABLA'">
                			<div class="tOrdenes" >
								<table id="ListaEstudiantes" class="display w-100">
									<thead>
									  <tr>
