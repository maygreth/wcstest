					...
					<div class="row g-brd-gray-light-v7">	
						...
						<div class="container">
							...
							<div class="row g-mb-70" ng-show="view=='GRID'">
								<div class="col-sm-6 col-lg-3 g-mb-30 " ng-repeat="personaje in listaData">
								<!-- Agents -->
									<div class="u-shadow-v11 u-shadow-v21--hover  text-center g-transition-0_3 ">
										<div class="g-bg-white g-pa-20">
											<div class=" mx-auto mb-10">
											  <img class="img-fluid g-brd-around g-brd-3 g-brd-gray-light-v3 g-width-130 g-height-130 rounded-circle rounded " src="{{personaje.image}}" alt="Image Description">
											</div>
											<h3 class="h5"><a class="g-color-main" href="#">{{personaje.name}}</a></h3>
											<span class="d-block g-color-gray-dark-v5 g-font-size-13 mb-1 g-height-20" >Patronus: {{personaje.patronus}}</span>
											<span class="d-block g-font-size-13 g-height-20" >Age: {{personaje.age}} <span ng-hide="personaje.age==''">years old</span> </span>
										</div>
									</div>
								<!-- End Agents -->
								</div>
